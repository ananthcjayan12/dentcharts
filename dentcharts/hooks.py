...
# Workspaces are now defined in /workspace directory structure
...
app_include_js = [
    "/assets/frappe/js/frappe/form/quick_entry.js"
]
...
doctype_js = {"Dental Chart": "public/js/dental_chart_visual.js"}
...
# Fixtures
# --------
# Workspaces are automatically loaded from /workspace directory
